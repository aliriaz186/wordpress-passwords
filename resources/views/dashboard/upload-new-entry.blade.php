...
@section('content')
    ...
    <div class="container" style="max-width: 900px;margin-top: 30px;margin-bottom: 50px">
        ...
        @endif
        <h3 style="letter-spacing: 3px" class="mt-4 mb-3">UPLOAD NEW ENTRY</h3>


        <form method="post" action="{{url("/saving-new-entry")}}" enctype="multipart/form-data">
            {{csrf_field()}}
            ...
            <div class="form-group row" style="width: 600px;margin-top: 30px;margin-bottom: 30px">
                ...
                <div class="col-lg-8">
                    <input type="text" class="form-control" placeholder="Enter Influencer" name="influencer" id="influencer" required>
                </div>
            </div>
            ...
            <div class="form-group row" style="width: 600px;margin-top: 30px;margin-bottom: 30px">
                ...
                <div class="col-lg-8">
                    <input type="text" class="form-control" placeholder="Enter Product (such as GUCCI)" name="productName" id="productName" required>
                </div>
            </div>
            ...
            <div class="form-group row" style="width: 600px;margin-top: 30px;margin-bottom: 30px">
                ...
                <div class="col-lg-8">
                    <input type="text" class="form-control" placeholder="Enter Product Type (such as hair/clothing/ beauty/food etc)" name="productType" id="productType" required>
                </div>
            </div>
            <div class="form-group row" style="width: 600px;margin-top: 30px;margin-bottom: 30px">
                <div class="col-lg-4">
                ...
                <div class="col-lg-8">
                    <input type="text" class="form-control" placeholder="Enter Promo Code" name="promoCode" id="promoCode" required>
                </div>
            </div>
            <div class="form-group row" style="width: 600px;margin-top: 30px;margin-bottom: 30px">
                <div class="col-lg-4">
                ...
                <div class="col-lg-8">
                    <input type="text" class="form-control" placeholder="Enter Youtube link or some other link here" name="info" id="info" required>
                </div>
            </div>
